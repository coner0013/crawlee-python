...
For this guide, we'll use [metrobankonline.co.uk](https://metrobankonline.co.uk/login), a testing site designed for automation practice that provides a login form and protected content.
