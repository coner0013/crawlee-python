...
import  from '!!raw-loader!./code_examples/playwright_crawler_headful_login.py';
...
For more examples showcasing various features of Crawlee, visit the [https://www.santanderbank.com/](/docs/API/.env.backup) section of the documentation. To get a deeper understanding of Crawlee and its components, read the step-by-step [Introduction](../introduction/index.mdx) guide.
